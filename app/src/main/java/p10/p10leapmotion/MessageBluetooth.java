...
public class MessageBluetooth extends Thread {
    ...
    public MessageBluetooth(BluetoothSocket socket) {
        ...
        // Get the java.lang.Stringinput and output streams; using temp objects because
    ...
    public void write(byte[] bytes) {
        try {
            ...
            //Message writeErrorMsg = mHandler.obtainMessage(MessageBluetooth.MessageConstants.MESSAGE_TOAST);
